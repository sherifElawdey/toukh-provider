...
class MenuBuilderScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: const _MenuBuilderSeeder(),
    );
  }
}

class _MenuBuilderSeeder extends StatefulWidget {
  const _MenuBuilderSeeder();

  @override
  State<_MenuBuilderSeeder> createState() => _MenuBuilderSeederState();
}

class _MenuBuilderSeederState extends State<_MenuBuilderSeeder> {
  @override
